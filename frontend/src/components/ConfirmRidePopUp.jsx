            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e) => {
                        ...
                        <input required value={otp} onChange={(e) => setOtp(e.target.value)} type="number" className='bg-[#eee] px-6 py-4 font-mono text-lg rounded-lg w-full mt-3' placeholder='Enter OTP' />
